...
const API_BASE = "https://ai-bug-tracker-api-lxtn.onrender.com/api/auth";
...
<motion.div variants={elementSlideUp} className="grid grid-cols-2 gap-4">
  <SocialBtn 
    label="Google"
    onClick={() => window.location.href = "https://ai-bug-tracker-api-lxtn.onrender.com/oauth2/authorization/google"}
  >
    <GoogleIcon />
  ...
  <SocialBtn  
    label="GitHub"
    onClick={() => window.location.href = "https://ai-bug-tracker-api-lxtn.onrender.com/oauth2/authorization/github"}
  >
    <GithubIcon />
